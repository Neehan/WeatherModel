...
WEATHER_PARAMS = {
    ...
    "Temperature at 2 Meters Maximum (C)": "T2M_MAX",  # 1
    "Temperature at 2 Meters Minimum (C)": "T2M_MIN",  # 2
    # "Wind Direction at 2 Meters (Degrees)": "WD2M",
    "Wind Speed at 2 Meters (m/s)": "WS2M",  # 4
    # "Surface Pressure (kPa)": "PS",
    # "Specific Humidity at 2 Meters (g/Kg)": "QV2M",
    "Precipitation Corrected (mm/day)": "PRECTOTCORR",  # 7
...
WEATHER_PARAMS = ["T2M_MAX", "T2M_MIN", "WS2M", "PRECTOTCORR"]
#                     1,        2,         4,      7
