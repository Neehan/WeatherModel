...
"""
This class implements the SimMTM (Siamese Masked Time-series Modeling) model.

The output is just mu (predicted values), similar to WeatherAutoencoder.
Uses contiguous segment masking with geometric mean length of 5.
Uses standard MSE loss for training.
"""


class SimMTM(WeatherBERT):
    def __init__(
        self,
        weather_dim,
        output_dim,
