...
class WeatherCNNTrainer(BaseTrainer):
    """
    CNN-based trainer that implements masked language modeling for weather data using convolutional networks.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.masking_function = (
            "weatherbert"  # Use same masking as BERT for consistency
        )
    ...
    def compute_train_loss(
        ...
        """Compute CNN training loss using MSE between predicted and actual masked tokens."""
    ...
    def compute_validation_loss(
        ...
        """Compute CNN validation loss using MSE between predicted and actual masked tokens."""
        target_tokens = data[feature_mask]
...
def weathercnn_training_loop(args_dict):
    """
    CNN training loop using the WeatherCNNTrainer class.
