...
parser.add_argument(
    "--crop-type",
    help="crop type to predict: soybean, corn, wheat, sunflower, cotton, sugarcane, beans",
    default="soybean",
    type=str,
    choices=["soybean", "corn", "wheat", "sunflower", "cotton", "sugarcane", "beans"],
)
parser.add_argument(
    "--country",
...
def main(args_dict=None):
    ...
    from src.crop_yield.trainers.simmtm_yield_trainer import (
        simmtm_yield_training_loop,
    )
    ...
    if model_type == "weatherbert":
        ...
        cross_validation_results = simmtm_yield_training_loop(
            args_dict, use_cropnet=False
        )
